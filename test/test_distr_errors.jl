...
rmprocs(prcs[1]) # 1
sleep(1)
println("1: supervisor ", Actors.diag(sv))
...
sleep(1)
println("2: supervisor ", Actors.diag(sv))
...
rmprocs(prcs[3]) # 3 
sleep(1)
println("3: supervisor ", Actors.diag(sv))
...
rmprocs(prcs[4]) # 4
sleep(1)
println("4: supervisor ", Actors.diag(sv))
@test @delayed length(sa.bhv.childs) == 3
@test @delayed length(ra.bhv.lks) == 2
...
rmprocs(prcs[end]) # 5
sleep(1)
println("5: supervisor ", Actors.diag(sv))
@test @delayed length(sa.bhv.childs) == 3
